...
> Documentazione su versioni precedenti dell'API Web per ASP.NET 4.x.


- [Abilitazione delle operazioni CRUD nell'API Web 1](creating-a-web-api-that-supports-crud-operations.md)
...
- [Self-hosting dell'API Web 1 (C#)](self-host-a-web-api.md)
