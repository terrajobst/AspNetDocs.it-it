...
---
# <a name="documentation-on-older-versions-of-web-api"></a>Documentazione sulle versioni precedenti dell'API Web

> Documentazione sulle versioni precedenti dell'API Web per ASP.NET 4. x.
