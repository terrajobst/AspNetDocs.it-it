...
Il **[EnableCors]** attributo implementa le **ICorsPolicyProvider** interfaccia. È possibile fornire un'implementazione personalizzata creando una classe che deriva da **attributo** e implementa **ICorsPolicyProvider**.
