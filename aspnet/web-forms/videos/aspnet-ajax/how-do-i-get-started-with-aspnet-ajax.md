...
---
# <a name="how-do-i-get-started-with-aspnet-ajax"></a>[Procedura:] Introduzione a ASP.NET AJAX

di [Joe Stagner spiega](https://github.com/JoeStagner)

Si noti che ASP.NET AJAX è incluso in .NET 3,5, pertanto la parte relativa all'installazione di questo video è pertinente solo se si usa la versione di .NET Framework 2,0.
