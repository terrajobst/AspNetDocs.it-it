...
---
# <a name="aspnet-4-quick-hit--new-rendering-option-for-check-box-lists-and-radio-button-lists"></a>ASP.NET 4 "Quick hit": nuova opzione di rendering per elenchi di caselle di controllo ed elenchi di pulsanti di opzione

di [Joe Stagner spiega](https://github.com/JoeStagner)

In questo video verranno fornite informazioni sull'opzione di rendering RepeatLayout per gli elenchi di caselle di controllo e di pulsanti di opzione. 
