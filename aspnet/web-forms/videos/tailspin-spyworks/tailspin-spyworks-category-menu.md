...
---
# <a name="tailspin-spyworks---category-menu"></a>Tailspin Spyworks - Menu per la categoria

da [Joe Stagner](https://github.com/JoeStagner)

Joe Stagner consente di compilare il menu di categoria per l'applicazione Web Form di esempio Tailspin Spyworks.

[&#9654;Guarda il video (7 minuti)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/tailspin-spyworks-category-menu)
