...
---
# <a name="quick-tour-of-the-visual-studio-2008-integrated-development-environment"></a>Presentazione rapida dell'ambiente di sviluppo integrato in Visual Studio 2008

di [Chris Pels](https://twitter.com/chrispels)

Panoramica delle nuove funzionalità e delle modifiche apportate all'IDE in Visual Studio 2008. Vedere l'editor di pagine Web aggiornato, progettazione form WPF, editor CSS e altro ancora.
