...
---
# <a name="how-do-i-enable-inline-gridview-editing"></a>Come è possibile abilitare la modifica inline di GridView?

di [Scott hanseln](https://github.com/shanselman)

Ora che è stato creato un sito con le visualizzazioni modifica e dettagli, come si Abilita la modifica inline in un controllo **GridView** ? In questo video vengono illustrate le procedure e il routing.
