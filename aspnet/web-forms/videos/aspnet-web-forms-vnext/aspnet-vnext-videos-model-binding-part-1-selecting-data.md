...
---
# <a name="aspnet-vnext-videos-model-binding-part-1---selecting-data"></a>ASP.NET vNext video: Associazione di modelli - parte 1: selezione dei dati

da [Damian Edwards](https://github.com/DamianEdwards)

In questo video, Damian Edwards inizia esaminando l'associazione di modelli descrivendo selezione dei dati.

[&#9654;Guarda il video (1 minuti)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-vnext-videos-model-binding-part-1-selecting-data)
