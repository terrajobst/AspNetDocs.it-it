...
[![Ail controllo utente sectionleveltutoriallisting. ascx a default. aspx gg](uploading-files-vb/_static/image2.gif)](uploading-files-vb/_static/image1.png)

**Figura 2**: Aggiungere il `SectionLevelTutorialListing.ascx` controllo utente da `Default.aspx` ([fare clic per visualizzare l'immagine con dimensioni normali](uploading-files-vb/_static/image2.png))
...
[![Binario che dati possono essere archiviati nel File System o direttamente nel Database](uploading-files-vb/_static/image4.gif)](uploading-files-vb/_static/image3.png)
...
[![Auna colonna BrochurePath con la tabella Categories gg](uploading-files-vb/_static/image5.gif)](uploading-files-vb/_static/image5.png)

**Figura 5**: Aggiungere un `BrochurePath` colonna per il `Categories` tabella ([fare clic per visualizzare l'immagine con dimensioni normali](uploading-files-vb/_static/image6.png))
...
[![CCrea un'immagine denominata DataColumn il cui tipo di dati è System. Byte []](uploading-files-vb/_static/image6.gif)](uploading-files-vb/_static/image7.png)
...
[![UElenco di colonne nell'istruzione SELECT per restituire anche BrochurePath elezionate](uploading-files-vb/_static/image7.gif)](uploading-files-vb/_static/image9.png)

**Figura 7**: Aggiornare l'elenco di colonne nel `SELECT` istruzione per restituire `BrochurePath` ([fare clic per visualizzare l'immagine con dimensioni normali](uploading-files-vb/_static/image10.png))
...
[![SScegliere l'Usa istruzioni SQL opzione](uploading-files-vb/_static/image8.gif)](uploading-files-vb/_static/image11.png)
...
[![Soiché la Query restituisce un Record dalla tabella Categories, scegliere Seleziona che restituisce righe](uploading-files-vb/_static/image9.gif)](uploading-files-vb/_static/image13.png)
...
[![Cimpostare come i nomi per i TableAdapter metodi](uploading-files-vb/_static/image10.gif)](uploading-files-vb/_static/image15.png)
...
[![Agg un controllo FileUpload nella pagina ASP.NET](uploading-files-vb/_static/image12.gif)](uploading-files-vb/_static/image17.png)
...
[![Tgli utenti possono selezionare un File da caricare dal proprio Computer al Server](uploading-files-vb/_static/image13.gif)](uploading-files-vb/_static/image19.png)
...
[![Tegli File EvolutionValley.jpg è stato caricato nel server Web](uploading-files-vb/_static/image14.gif)](uploading-files-vb/_static/image21.png)

**Figura 14**: Il File `EvolutionValley.jpg` è stato caricato nel server Web ([fare clic per visualizzare l'immagine con dimensioni normali](uploading-files-vb/_static/image22.png))
...
- [Utilizzo di tipi di dati per valori di grandi dimensioni](https://msdn.microsoft.com/library/ms178158.aspx)
