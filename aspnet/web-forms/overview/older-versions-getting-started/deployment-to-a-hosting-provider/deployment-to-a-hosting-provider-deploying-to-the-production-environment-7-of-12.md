...
Nel **gestione File** , quindi selezionare **contosouniversity.com** e quindi **wwwroot** per visualizzare una cartella radice dell'applicazione. Fare clic sull'icona del lucchetto accanto a **Elmah**.
