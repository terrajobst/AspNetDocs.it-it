...
ms.locfileid: "74635739"
---
# <a name="precompiling-your-website-c"></a>Precompilazione del sito Web (C#)

di [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Scarica codice](https://download.microsoft.com/download/1/0/C/10CC829F-A808-4302-97D3-59989B8F9C01/ASPNET_Hosting_Tutorial_15_CS.zip) o [Scarica PDF](https://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial15_Precompiling_cs.pdf)
...
**Figura 1**: lo strumento di compilazione ASP.NET consente di precompilare il sito Web nel percorso di destinazione specificato  
 ([Fare clic per visualizzare l'immagine con dimensioni complete](precompiling-your-website-cs/_static/image3.png))
...
**Figura 2**: la directory del progetto contiene file di `.aspx` e di `.aspx.cs`; la cartella `Bin` include solo `Elmah.dll`  
 ([Fare clic per visualizzare l'immagine con dimensioni complete](precompiling-your-website-cs/_static/image6.png))
...
**Figura 3**: la cartella del percorso di destinazione include i file per la distribuzione  
 ([Fare clic per visualizzare l'immagine con dimensioni complete](precompiling-your-website-cs/_static/image9.png))
...
**Figura 4**: deselezionare l'opzione "Consenti l'aggiornabilità di questo sito precompilato" per la precompilazione con un'interfaccia utente non aggiornabile  
 ([Fare clic per visualizzare l'immagine con dimensioni complete](precompiling-your-website-cs/_static/image12.png))
...
**Figura 5**: cartella del percorso di destinazione per la distribuzione con un'interfaccia utente non aggiornabile  
 ([Fare clic per visualizzare l'immagine con dimensioni complete](precompiling-your-website-cs/_static/image15.png))
