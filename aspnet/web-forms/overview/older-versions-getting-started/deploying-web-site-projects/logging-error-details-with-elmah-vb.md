...
ms.locfileid: "78525711"
---
# <a name="logging-error-details-with-elmah-vb"></a>Registrazione dei dettagli degli errori con ELMAH (VB)

di [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Scarica codice](https://download.microsoft.com/download/1/0/C/10CC829F-A808-4302-97D3-59989B8F9C01/ASPNET_Hosting_Tutorial_14_VB.zip) o [Scarica PDF](https://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial14_ELMAH_vb.pdf)
...
([Fare clic per visualizzare l'immagine con dimensioni complete](logging-error-details-with-elmah-vb/_static/image7.png))
...
([Fare clic per visualizzare l'immagine con dimensioni complete](logging-error-details-with-elmah-vb/_static/image10.png))
...
([Fare clic per visualizzare l'immagine con dimensioni complete](logging-error-details-with-elmah-vb/_static/image13.png))
...
([Fare clic per visualizzare l'immagine con dimensioni complete](logging-error-details-with-elmah-vb/_static/image16.png))
...
> [!NOTE]
> Il ruolo di amministratore e i tre utenti del sistema, Scott, Jisun e Alice, sono stati aggiunti nell'esercitazione [ *configurazione di un sito Web che usa servizi per le applicazioni* ](configuring-a-website-that-uses-application-services-vb.md). Gli utenti Scott e Jisun sono membri del ruolo amministratore. Per ulteriori informazioni sull'autenticazione e l'autorizzazione, vedere le [esercitazioni sulla sicurezza del sito Web](../../older-versions-security/introduction/security-basics-and-asp-net-support-cs.md).
...
([Fare clic per visualizzare l'immagine con dimensioni complete](logging-error-details-with-elmah-vb/_static/image19.png))
...
([Fare clic per visualizzare l'immagine con dimensioni complete](logging-error-details-with-elmah-vb/_static/image22.png))
