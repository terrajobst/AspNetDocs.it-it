...
ms.locfileid: "57046978"
---
<a name="jquery-datatables-1104"></a><span data-ttu-id="c7dac-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="c7dac-102">jQuery DataTables 1.10.4</span></span>
====================
<span data-ttu-id="c7dac-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="c7dac-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
