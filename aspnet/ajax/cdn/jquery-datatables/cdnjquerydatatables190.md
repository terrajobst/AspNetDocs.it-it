...
---
# <a name="jquery-datatables-190"></a><span data-ttu-id="a5bff-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="a5bff-102">jQuery DataTables 1.9.0</span></span>

<span data-ttu-id="a5bff-103">I file seguenti per i plug-in jQuery DataTables sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="a5bff-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
