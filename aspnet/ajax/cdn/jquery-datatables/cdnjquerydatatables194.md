...
ms.locfileid: "78563210"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="892ac-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="892ac-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="892ac-103">I file seguenti per i plug-in jQuery DataTables sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="892ac-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
