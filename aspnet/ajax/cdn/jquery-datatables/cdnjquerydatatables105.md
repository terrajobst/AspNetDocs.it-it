...
ms.locfileid: "57030688"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="778d8-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="778d8-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="778d8-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="778d8-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
