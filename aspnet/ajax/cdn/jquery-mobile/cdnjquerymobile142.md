...
ms.locfileid: "59405001"
---
# <a name="jquery-mobile-142-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="c539a-102">jQuery Mobile 1.4.2 sulla rete CDN Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="c539a-102">jQuery Mobile 1.4.2 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="c539a-103">La libreria di jQuery Mobile 1.4.2 include i file seguenti:</span><span class="sxs-lookup"><span data-stu-id="c539a-103">The jQuery Mobile 1.4.2 library includes the following files:</span></span>
