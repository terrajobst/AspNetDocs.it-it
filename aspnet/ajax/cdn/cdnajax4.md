...
ms.locfileid: "78563350"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="b1dbf-102">Web Forms ASP.NET e Ajax 4</span><span class="sxs-lookup"><span data-stu-id="b1dbf-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="b1dbf-103">I file seguenti sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="b1dbf-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="b1dbf-104">Nota: gli script di globalizzazione, ad esempio fr-FR. js, si trovano nella cartella seguente:</span><span class="sxs-lookup"><span data-stu-id="b1dbf-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
