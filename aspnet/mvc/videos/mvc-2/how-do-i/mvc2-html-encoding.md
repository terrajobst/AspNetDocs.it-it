...
In questo video si apprenderà come usare la nuova sintassi di collegamento per la codifica HTML in ASP.NET per proteggersi da attacchi di script injection e per usare MvcHtmlString quando si vuole includere codice HTML nelle stringhe.
