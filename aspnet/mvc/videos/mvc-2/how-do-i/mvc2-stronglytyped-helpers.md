...
---
# <a name="mvc2---stronglytyped-helpers"></a>MVC2 - Helper fortemente tipizzati

by [Microsoft](https://github.com/microsoft)

In questo video che si apprenderà come è possibile usare fortemente tipizzate helper HTML per ottenere il tipo di compilazione-verifica durante la creazione di elementi dell'interfaccia utente HTML.

[&#9654;Guarda il video (2 minuti)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/mvc2-stronglytyped-helpers)
