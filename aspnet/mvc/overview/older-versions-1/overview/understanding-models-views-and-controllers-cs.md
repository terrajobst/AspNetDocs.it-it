...
**Figura 01**: finestra di dialogo nuovo progetto ([fare clic per visualizzare l'immagine con dimensioni complete](understanding-models-views-and-controllers-cs/_static/image2.png))
...
[Finestra di dialogo ![Crea unit test](understanding-models-views-and-controllers-cs/_static/image2.jpg)](understanding-models-views-and-controllers-cs/_static/image3.png)

**Figura 02**: finestra di dialogo Crea unit test ([fare clic per visualizzare l'immagine con dimensioni complete](understanding-models-views-and-controllers-cs/_static/image4.png))
...
**Figura 03**: finestra Esplora soluzioni ([fare clic per visualizzare l'immagine con dimensioni complete](understanding-models-views-and-controllers-cs/_static/image6.png))
...
[![finestra di dialogo debug non abilitato](understanding-models-views-and-controllers-cs/_static/image4.jpg)](understanding-models-views-and-controllers-cs/_static/image7.png)

**Figura 04**: finestra di dialogo debug non abilitato ([fare clic per visualizzare l'immagine con dimensioni complete](understanding-models-views-and-controllers-cs/_static/image8.png))
...
[![pagina di indice](understanding-models-views-and-controllers-cs/_static/image10.png)](understanding-models-views-and-controllers-cs/_static/image9.png)

**Figura 05**: pagina di indice ([fare clic per visualizzare l'immagine con dimensioni complete](understanding-models-views-and-controllers-cs/_static/image11.png))
...
Un controller è semplicemente una classe (ad esempio, un Visual Basic o C# una classe). L'applicazione ASP.NET MVC di esempio include un controller denominato HomeController.cs che si trova nella cartella Controllers. Il contenuto del file HomeController.cs viene riprodotto nel listato 2.
