...
title: Creazione di classi di modelli con ilC#Entity Framework () | Microsoft Docs
author: microsoft
...
Ricordarsi di salvare il Entity Data Model dopo aver apportato una modifica facendo clic sul pulsante Salva (icona del disco floppy). Dietro le quinte, il Entity Designer genera un set C# di classi. È possibile visualizzare queste classi aprendo il file MoviesDBModel.Designer.cs dalla finestra Esplora soluzioni.

Non modificare il codice nel file Designer.cs perché le modifiche verranno sovrascritte alla successiva utilizzo del Entity Designer. Se si desidera estendere la funzionalità delle classi di entità definite nel file Designer.cs, è possibile creare *classi parziali* in file distinti.
...
La vista nel listato 2 contiene un ciclo **foreach** che esegue l'iterazione di ogni record cinematografico e Visualizza i valori delle proprietà title e Director del record cinematografico. Si noti che accanto a ogni record viene visualizzato un collegamento modifica ed Elimina. Viene inoltre visualizzato un collegamento Aggiungi film nella parte inferiore della visualizzazione (vedere la figura 7).

**Figura 7: visualizzazione dell'indice**

![clip_image014](creating-model-classes-with-the-entity-framework-cs/_static/image7.jpg)

La vista index è una *visualizzazione tipizzata*. La vista index include una direttiva &lt;% @ page%&gt; con un attributo *Inherits* che esegue il cast della proprietà Model a una raccolta di elenchi generici fortemente tipizzata di oggetti film (elenco&lt;film).
...
**Listato 4-Controllers\HomeController.cs (modifica metodi)**
...
**Listato 6--\Controllers\HomeController.cs (Elimina azione)**
