...
In questa sezione si esamineranno generato `Edit` metodi di azione e visualizzazioni per il controller di film. Ma prima di tutto questo articolo verrà fornita una breve deviazione per rendere la data di rilascio di un aspetto migliore. Aprire il *Models\Movie.cs* file e aggiungere le righe evidenziate illustrate di seguito:
